...
import { CompareTable } from "@/components/sections/comparePlan/ComparePlanTable";
import { usePillTimeline } from "./animations/usePillTimeline";
...
export default function PillView({ model }) {
  ...
  return (
    <>
      <div ref={sectionRef} className={styles.pillSection}>
        <div className={styles.svgScrollWrapper} ref={containerRef}>
          ...
          >
            <CdnImage
              src="https://cdn.memorae.ai/mem-next/homepage/Memorae_Character.png"
              alt="Memorae Logo"
