            ...
            <div className={styles.tagParent}>
              <div className={styles.tag}>
                <img
                  ...
                  alt="Calendar icon"
                  src="https://cdn.memorae.ai/mem-next/homepage/calendar_today.svg"
                />
            ...
            <div className={styles.tagGroup}>
              <div className={styles.tag1}>
                <img
                  ...
                  alt="List icon"
                  src="https://cdn.memorae.ai/mem-next/homepage/article.svg"
                />
            ...
            <div className={styles.tagParent}>
              <div className={styles.tag2}>
                <img
                  className={styles.calendarTodayIcon}
                  alt="Reminder icon"
                  src="https://cdn.memorae.ai/mem-next/homepage/calendar_today-1.svg"
                />
