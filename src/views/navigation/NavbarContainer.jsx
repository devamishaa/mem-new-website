...
import NavbarView from "@/views/navigation/NavbarView";
import SectionEffects from "@/components/animations/clients/SectionEffects.client";
...
export default function NavbarContainer(props) {
  ...
  return (
    <SectionEffects>
      <NavbarView overlay={overlay} logoHref={logoHref} model={model} />
    </SectionEffects>
  );
}
