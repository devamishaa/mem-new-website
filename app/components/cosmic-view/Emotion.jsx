...
export default function CosmicLanding({ model }) {
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => {
      const isMobile = window.innerWidth <= 600;
      // Show fewer stars on small screens instead of hiding them
      const starCount = isMobile ? 32 : window.innerWidth > 1200 ? 60 : 25;
      ...
      setStars(generated);
      if (isMobile) {
        // Skip heavy horizon/shooting star animations on mobile, but keep base stars
  ...
  return (
    ...
    >
      ...
      <div
        data-cosmic-arc
        className="absolute bottom-0 left-1/2 w-[150vw] h-[20vh] -translate-x-1/2 rounded-t-[60%] sm:rounded-t-[70%] lg:rounded-t-[80%] z-10"
      >
        <div className="absolute inset-0 w-[150vw] h-[40vh] left-1/2 -translate-x-1/2 rounded-t-[50%] sm:rounded-t-[60%] lg:rounded-t-[70%] bg-[#090d10] shadow-[0_-50px_100px_-40px_#ff9cd9,0_-20px_60px_-20px_rgba(255,102,196,0.5),0_-10px_30px_-10px_rgba(2,1,1,0.3)] animate-[shadowShift_6s_ease-in-out_infinite_alternate]" />
      </div>
      <div className="sm:mb-8 absolute mt-10 sm:left-[50%] left-20 top-0">
        <Image
          src={memorae}
          alt="Memorae"
          data-cosmic-image
      ...
      {/* Content */}
      <div className="mt-10 sm:mt-1 relative z-20 flex min-h-screen flex-col items-center justify-center px-4 pt-12 pb-20 text-center">
        <h1
          data-cosmic-text-1
