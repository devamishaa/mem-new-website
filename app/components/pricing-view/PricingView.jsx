...
const PricingView = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 sm:mt-4 mt-0 flex w-full max-w-7xl flex-col items-center gap-8">
        {selected && plans[selected] ? (
          <p className="text-lg sm:text-xl lg:text-2xl font-[500] text-white text-left px-2 leading-tight">
