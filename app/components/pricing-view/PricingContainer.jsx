    ...
    return {
      ...
      life: [
        ...
        },
        {
          ...
          label: tPricing("plans.lifetime.features.mirrorMode", "Custom lists"),
          description: tPricing(
            "plans.lifetime.features.listDescription",
        ...
        },
        {
          ...
          label: tPricing("plans.lifetime.features.dashboard", "Dashboard"),
          description: tPricing(
            "plans.lifetime.features.dashboardDescription",
            "Comprehensive dashboard view"
          ),
