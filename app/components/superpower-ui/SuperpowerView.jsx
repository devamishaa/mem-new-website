...
// --- Start of inlined useSuperpowerTimeline.js code ---
...
const SuperpowerView = ({ model }) => {
      ...
      const ctx = gsap.context(() => {
        ...
        const tl = gsap.timeline({
          ...
          scrollTrigger: {
            ...
            scrub: config.isMobile ? 0.3 : 0.5, // Smoother scrub values
            pin: true,
            pinSpacing: true,
            anticipatePin: 1, // Optimal anticipation for smooth pinning
            ...
            // Smooth pinning callbacks
            onEnter: () => {
              gsap.set(elements.stage, { willChange: "transform" });
            },
            onLeave: () => {
              gsap.set(elements.stage, { willChange: "auto" });
            },
            onEnterBack: () => {
              gsap.set(elements.stage, { willChange: "transform" });
            },
        ...
        tl.to(
          elements.panel2,
          {
            ...
            ease: "power2.out", // Smooth easing for takeover
  ...
  return (
    <section
      ref={containerRef}
      className="relative flex min-h-screen w-full flex-col overflow-hidden bg-[#061120] font-figtree"
    ...
    >
      <SuperpowerContent
        ...
        model={model}
      />
      <SuperpowerSlides model={model} activeSlide={currentIndex} />
    </section>
  );
};
