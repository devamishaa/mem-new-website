...
export function useSuperpowerTimeline(
  ...
  useLayoutEffect(() => {
    console.log("useSuperpowerTimeline - currentIndex changed:", currentIndex);
  }, [currentIndex, setCurrentEmotionImage, setCurrentEmotionText]);
  ...
  useLayoutEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      const setActive = (idx) => {
        ...
        console.log("useSuperpowerTimeline - setActive called with idx:", idx);
        prevIdx = idx;
        setCurrentIndex(idx);
